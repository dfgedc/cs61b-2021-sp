    ...
    public static boolean atLeastOneMoveExists(Board b) {
        ...
        int size = b.size();
         ...
         if (bl){
             ...
             if(b.tile(0,size-1).value() == b.tile(1,size-1).value()||b.tile(0,size-1).value() == b.tile(0,size-2).value() ){
                 return true;
             }
             if(b.tile(size-1,0).value() == b.tile(size-2,0).value()||b.tile(size-1,0).value() == b.tile(size-1,1).value() ){
                 return true;
             }
             if(b.tile(size-1,size-1).value() == b.tile(size-2,size-1).value()||b.tile(size-1,size-1).value() == b.tile(size-1,size-2).value() ){
                 return true;
             }
         }
         return false;
